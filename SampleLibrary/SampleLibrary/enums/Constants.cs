...
{
    public static readonly string TokenizerDelimiterRegex = "[\\s,]+";
    public static readonly string TextRefiningRegex = "[^a-zA-Z ]+";
    public static readonly string WhiteSpaceRegex = "\\s+";

    public static readonly string StoppingWords =
    ...
    public static readonly string MustIncludingWordsRegex = "^([^\\+-]+)$";
    public static readonly string PositiveWordsRegex = "\\+(.*)";
    public static readonly string NegativeWordsRegex = "-(.*)";
}