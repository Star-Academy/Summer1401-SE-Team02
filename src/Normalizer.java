...
public class Normalizer {
    ...
    static private final ArrayList<String> stopWords = new ArrayList<String>(Arrays.asList("OURSELVES", "HERS",
            "BETWEEN", "YOURSELF", "BUT", "AGAIN", "THERE", "ABOUT", "ONCE", "DURING", "OUT", "VERY", "HAVING", "WITH",
            "THEY", "OWN", "AN", "BE", "SOME", "FOR", "DO", "ITS", "YOURS", "SUCH", "INTO", "OF", "MOST", "ITSELF",
            "OTHER", "OFF", "IS", "S", "AM", "OR", "WHO", "AS", "FROM", "HIM", "EACH", "THE", "THEMSELVES", "UNTIL",
            ...
            "SHE", "ALL", "NO", "WHEN", "AT", "ANY", "BEFORE", "THEM", "SAME", "AND", "BEEN", "HAVE", "IN", "WILL",
